  ...
  return (
    <PopupContainer setPopup={setPopup} closeBtn>
      <div className="bg-white w-[90vw] md:w-[30vw] rounded-md shadow-md py-6 lg:px-10 px-4 flex flex-col gap-3">
        ...
        <form action="" className="flex flex-col gap-3" onClick={handleSubmit(onSubmit)}>
          <div class="relative h-10 w-full">
            <input
              class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-black focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
              placeholder=" "
              type="text"
